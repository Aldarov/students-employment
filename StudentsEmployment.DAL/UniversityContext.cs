...
namespace StudentsEmployment.DAL
{
    public class UniversityContext : DbContext
    {
        ...
        public DbSet<Kladr> Kladr { get; set; }
        public DbSet<PgContractInfo> PgContractInfos { get; set; }
        public DbSet<PgContractStuff> PgContractStuffs { get; set; }
        public DbSet<PgGraduateWorkplace> PgGraduateWorkplaces { get; set; }
        public DbSet<PgHeader> PgHeaders { get; set; }
        public DbSet<PgKind> PgKinds { get; set; }
        public DbSet<PgType> PgTypes { get; set; }
